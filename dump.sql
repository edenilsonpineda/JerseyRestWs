...
TRUNCATE `ALUMNOS`;
INSERT INTO `ALUMNOS` (`nombreAlumno`, `id`, `fechaNacimiento`, `numeroTelefono`, `email`, `curso`) VALUES
...
TRUNCATE `CURSOS`;
INSERT INTO `CURSOS` (`id`, `nombreCurso`, `nombreProfesor`, `numeroTelefono`, `email`) VALUES
